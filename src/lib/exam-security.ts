...
export function normalizeSecuritySettings(
  ...
  if (!merged.allowCalculator) {
    merged.calculatorType = merged.calculatorType === "scientific" ? "scientific" : "basic";
  }
  return merged;
}
